...
function ue(e, A, t) {
    if (arguments.length === 2)
        for (var r = 0, B = A.length, n; r < B; r++) (n || !(r in A)) && (n || (n = Array.prototype.slice.call(A, 0, r)), (n[r] = A[r]));
    return e.concat(n || A);
}
var cA = (function () {
        function e(A, t, r, B) {
    ...
    an = function (e) {
        ...
        var r = Math.max(Math.max(A.scrollWidth, t.scrollWidth), Math.max(A.offsetWidth, t.offsetWidth), Math.max(A.clientWidth, t.clientWidth)),
            B = Math.max(Math.max(A.scrollHeight, t.scrollHeight), Math.max(A.offsetHeight, t.offsetHeight), Math.max(A.clientHeight, t.clientHeight));
...
var Qn = function (e) {
        ...
        var o = typeof ArrayBuffer < "u" && typeof Uint8Array < "u" && typeof Uint8Array.prototype.slice < "u" ? new ArrayBuffer(A) : new Array(A),
        ...
        return (
            ...
            (e.prototype.consumeUrlToken = function () {
                ...
                if (t === pe || t === He) {
                    ...
                    return r.type === 0 && (this.consumeWhiteSpace(), this.peekCodePoint(0) === nA || this.peekCodePoint(0) === jA)
            ...
            (e.prototype.consumeNumber = function () {
                ...
                if (r === ge && J(B))
                    for (A.push(this.consumeCodePoint(), this.consumeCodePoint()), t = ft; J(this.peekCodePoint(0));) A.push(this.consumeCodePoint());
        ...
        switch (e.size) {
            case 0:
                e.shape === 0
                    ...
                    : e.shape === 1 && ((n = Math.min(Math.abs(A), Math.abs(A - r))), (s = Math.min(Math.abs(t), Math.abs(t - B))));
                break;
            case 2:
            ...
            case 1:
                e.shape === 0
                    ...
                    : e.shape === 1 && ((n = Math.max(Math.abs(A), Math.abs(A - r))), (s = Math.max(Math.abs(t), Math.abs(t - B))));
                break;
            case 3:
    ...
    pi = {
        ...
        parse: function (e, A) {
            return A.length === 1 && Xr(A[0], "none")
                ? []
                : sA(A).map(function (t) {
                      for (var r = { color: 255, offsetX: X, offsetY: X, blur: X, spread: X, inset: !1 }, B = 0, n = 0; n < t.length; n++) {
                          var s = t[n];
                          Xr(s, "inset")
                              ? (r.inset = !0)
                              : pA(s)
                                ? (B === 0 ? (r.offsetX = s) : B === 1 ? (r.offsetY = s) : B === 2 ? (r.blur = s) : (r.spread = s), B++)
    ...
    Ki = (function () {
        function e(A, t) {
            ...
            ((this.overflowX = n[0]),
                ...
                (this.textDecorationLine = U(A, ci, (B = t.textDecorationLine) !== null && B !== void 0 ? B : t.textDecoration)),
...
var qi = 1,
    ...
    lo = function (e, A) {
        for (
            var t = _n(e, { lineBreak: A.lineBreak, wordBreak: A.overflowWrap === "break-word" ? "break-word" : A.wordBreak }),
                r = [],
                B,
                n = function () {
                    if (B.value) {
    ...
    $t = (function () {
        ...
        return (
                                        ...
                                        return (
                                            ...
                                            i &&
                                                ...
                                                /(iPad|iPhone|iPod)/g.test(navigator.userAgent) &&
                                                    ...
                                                    (this.context.windowBounds = this.context.windowBounds.add(i.scrollX - t.left, i.scrollY - t.top, 0, 0)))),
            ...
            (e.prototype.appendChildNode = function (A, t, r) {
                (!_A(t) || (!To(t) && !t.hasAttribute($B) && (typeof this.options.ignoreElements != "function" || !this.options.ignoreElements(t)))) &&
                        ...
                        switch (i.label) {
                            case 0:
                                return (
                                    ...
                                    !t && this._options.allowTaint === !1 && !vr(A) && !yr(A) && !B && !r ? [2] : ((n = A), B ? [4, this.proxy(n)] : [3, 2])
                                );
                            case 1:
                                ((n = i.sent()), (i.label = 2));
                            case 2:
    ...
    tQ = (function () {
        function e(A) {
            ...
            ((this.topLeftBorderDoubleOuterBox =
                n > 0 || s > 0 ? x(r.left + E / 3, r.top + l / 3, n - E / 3, s - l / 3, m.TOP_LEFT) : new u(r.left + E / 3, r.top + l / 3)),
                (this.topRightBorderDoubleOuterBox =
                    n > 0 || s > 0 ? x(r.left + F, r.top + l / 3, a - v / 3, o - l / 3, m.TOP_RIGHT) : new u(r.left + r.width - v / 3, r.top + l / 3)),
                (this.bottomRightBorderDoubleOuterBox =
                    g > 0 || w > 0
                        ? x(r.left + p, r.top + K, g - v / 3, w - y / 3, m.BOTTOM_RIGHT)
                        : new u(r.left + r.width - v / 3, r.top + r.height - y / 3)),
                (this.bottomLeftBorderDoubleOuterBox =
                    c > 0 || C > 0 ? x(r.left + E / 3, r.top + d, c - E / 3, C - y / 3, m.BOTTOM_LEFT) : new u(r.left + E / 3, r.top + r.height - y / 3)),
                ...
                (this.topLeftBorderStroke =
                    n > 0 || s > 0 ? x(r.left + E / 2, r.top + l / 2, n - E / 2, s - l / 2, m.TOP_LEFT) : new u(r.left + E / 2, r.top + l / 2)),
                (this.topRightBorderStroke =
                    n > 0 || s > 0 ? x(r.left + F, r.top + l / 2, a - v / 2, o - l / 2, m.TOP_RIGHT) : new u(r.left + r.width - v / 2, r.top + l / 2)),
                (this.bottomRightBorderStroke =
                    g > 0 || w > 0
                        ? x(r.left + p, r.top + K, g - v / 2, w - y / 2, m.BOTTOM_RIGHT)
                        : new u(r.left + r.width - v / 2, r.top + r.height - y / 2)),
                (this.bottomLeftBorderStroke =
                    c > 0 || C > 0 ? x(r.left + E / 2, r.top + d, c - E / 2, C - y / 2, m.BOTTOM_LEFT) : new u(r.left + E / 2, r.top + r.height - y / 2)),
                (this.topLeftBorderBox = n > 0 || s > 0 ? x(r.left, r.top, n, s, m.TOP_LEFT) : new u(r.left, r.top)),
                (this.topRightBorderBox = a > 0 || o > 0 ? x(r.left + F, r.top, a, o, m.TOP_RIGHT) : new u(r.left + r.width, r.top)),
                (this.bottomRightBorderBox = g > 0 || w > 0 ? x(r.left + p, r.top + K, g, w, m.BOTTOM_RIGHT) : new u(r.left + r.width, r.top + r.height)),
                (this.bottomLeftBorderBox = c > 0 || C > 0 ? x(r.left, r.top + d, c, C, m.BOTTOM_LEFT) : new u(r.left, r.top + r.height)),
                (this.topLeftPaddingBox =
                    n > 0 || s > 0 ? x(r.left + E, r.top + l, Math.max(0, n - E), Math.max(0, s - l), m.TOP_LEFT) : new u(r.left + E, r.top + l)),
                (this.topRightPaddingBox =
                    a > 0 || o > 0
                        ? x(r.left + Math.min(F, r.width - v), r.top + l, F > r.width + v ? 0 : Math.max(0, a - v), Math.max(0, o - l), m.TOP_RIGHT)
                        : new u(r.left + r.width - v, r.top + l)),
                (this.bottomRightPaddingBox =
                    g > 0 || w > 0
                        ? x(r.left + Math.min(p, r.width - E), r.top + Math.min(K, r.height - y), Math.max(0, g - v), Math.max(0, w - y), m.BOTTOM_RIGHT)
                ...
                (this.topRightContentBox =
                    a > 0 || o > 0
                        ? x(r.left + Math.min(F, r.width + E + L), r.top + l + O, F > r.width + E + L ? 0 : a - E + L, o - (l + O), m.TOP_RIGHT)
...
var x = function (e, A, t, r, B) {
    ...
    Bn = function (e, A) {
        for (var t = e instanceof kr ? e.start : 1, r = e instanceof kr ? e.reversed : !1, B = 0; B < A.length; B++) {
            var n = A[B];
            (n.container instanceof NB && typeof n.container.value == "number" && n.container.value !== 0 && (t = n.container.value),
                        ...
                        switch (l.label) {
                            ...
                            case 13:
                                ((Q = l.sent()),
                                    r.width &&
                                        r.height &&
                                        this.ctx.drawImage(Q, 0, 0, r.width, r.height, r.bounds.left, r.bounds.top, r.bounds.width, r.bounds.height),
                                    (l.label = 14));
                            case 14:
                                if (
                                    (r instanceof tt &&
                            ...
                            case 19:
                                (t.listValue &&
                                    ...
                                    this.renderTextWithLetterSpacing(new ie(t.listValue, d), n.letterSpacing, yt(n.lineHeight, n.fontSize.number) / 2 + 2),
            ...
            (A.prototype.formatPath = function (t) {
                ...
                t.forEach(function (B, n) {
                    ...
                    (n === 0 ? r.ctx.moveTo(s.x, s.y) : r.ctx.lineTo(s.x, s.y),
                        $(B) && r.ctx.bezierCurveTo(B.startControl.x, B.startControl.y, B.endControl.x, B.endControl.y, B.end.x, B.end.y));
                });
            }),
        ...
        function A(t, r) {
            ...
            return (
                ...
                B.context.logger.debug(
                    "EXPERIMENTAL ForeignObject renderer initialized (" + r.width + "x" + r.height + " at " + r.x + "," + r.y + ") with scale " + r.scale
                ),
                B
            );
        }
        ...
        return P(void 0, void 0, void 0, function () {
            ...
            return _(this, function (oA) {
                switch (oA.label) {
                    ...
                    case 3:
                        return (
                            a.logger.debug("Document cloned, element located at " + h + "," + F + " with size " + C + "x" + H + " using computed rendering"),
