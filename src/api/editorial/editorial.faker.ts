...
export const getGetEditorialFollowersResponseMock = (
  overrideResponse: Partial<Extract<GetEditorialFollowers200, object>> = {},
): GetEditorialFollowers200 => ({
  facebook: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
    undefined,
  ]),
  twitter: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
    undefined,
  ]),
  linkedin: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
    undefined,
  ]),
  instagram: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
    undefined,
  ]),
  ...overrideResponse,
...
export const getGetEditorialMegamenuResponseMock = (
  overrideResponse: Partial<Extract<GetEditorialMegamenu200, object>> = {},
): GetEditorialMegamenu200 => ({
...
export const getGetEditorialCategoriesResponseMock =
  (): GetEditorialCategories200Item[] =>
    Array.from(
...
export const getGetEditorialArticlesByCategoryResponseMock = (): Article[] =>
  Array.from(
    ...
    link_text: faker.helpers.arrayElement([
      faker.string.alpha({ length: { min: 10, max: 20 } }),
      undefined,
    ]),
