...
export const getMapEditByEditId = async (
  ...
  return fetchWithAuth<getMapEditByEditIdResponse>(
    getGetMapEditByEditIdUrl(editId),
    {
      ...options,
      method: "GET",
    },
...
export const getMapFileByViewId = async (
  ...
  return fetchWithAuth<getMapFileByViewIdResponse>(
    getGetMapFileByViewIdUrl(viewId),
    {
      ...options,
      method: "GET",
    },
...
export const getMapFileByEditId = async (
  ...
  return fetchWithAuth<getMapFileByEditIdResponse>(
    getGetMapFileByEditIdUrl(editId),
    {
      ...options,
      method: "GET",
    },
...
export const deleteMapByEditId = async (
  ...
  return fetchWithAuth<deleteMapByEditIdResponse>(
    getDeleteMapByEditIdUrl(editId),
    {
      ...options,
      method: "DELETE",
    },
...
export const patchMapByEditId = async (
  ...
  return fetchWithAuth<patchMapByEditIdResponse>(
    getPatchMapByEditIdUrl(editId),
    {
      ...options,
      method: "PATCH",
      headers: {
...
export const postMapFileByEditId = async (
  ...
  return fetchWithAuth<postMapFileByEditIdResponse>(
    getPostMapFileByEditIdUrl(editId),
    {
      ...options,
      method: "POST",
      body: formData,
