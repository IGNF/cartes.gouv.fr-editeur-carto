...
export const getGetUserMediasResponseMock = (
  overrideResponse: Partial<Extract<MediaList, object>> = {},
): MediaList =>
  faker.helpers.arrayElement([
    {
      medias: faker.helpers.arrayElement([
        Array.from(
          ...
          view_url: faker.helpers.arrayElement([
            faker.internet.url(),
            undefined,
          ]),
          thumb_url: faker.helpers.arrayElement([
            faker.internet.url(),
            undefined,
          ]),
        })),
...
export const getPostMediaResponseMock = (
  overrideResponse: Partial<Extract<Media, object>> = {},
): Media => ({
  id: faker.helpers.arrayElement([faker.number.int(), undefined]),
  name: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
...
export const getGetUserMediaFoldersResponseMock = (): string[] =>
  Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, () =>
    faker.word.sample(),
  );

export const getDeleteMediaByIdResponseMock = (
...
export const getPutMediaAttributeResponseMock = (
  overrideResponse: Partial<Extract<PutMediaAttribute200, object>> = {},
): PutMediaAttribute200 => ({
  id: faker.helpers.arrayElement([faker.number.int(), undefined]),
...
export const getPostMediaFileByIdResponseMock = (
  overrideResponse: Partial<Extract<PostMediaFileById200, object>> = {},
): PostMediaFileById200 => ({
  id: faker.helpers.arrayElement([faker.number.int(), undefined]),
  attribute: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
