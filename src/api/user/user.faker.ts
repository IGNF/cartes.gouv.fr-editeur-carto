...
export const getGetMeResponseMock = (): UserView => ({
  ...{
    ...{
      ...
      twitter_account: faker.helpers.arrayElement([
        faker.string.alpha({ length: { min: 10, max: 20 } }),
        undefined,
      ]),
      facebook_account: faker.helpers.arrayElement([
        faker.string.alpha({ length: { min: 10, max: 20 } }),
        undefined,
      ]),
      linkedin_account: faker.helpers.arrayElement([
        faker.string.alpha({ length: { min: 10, max: 20 } }),
        undefined,
      ]),
  ...
  ...{
    ...
    medias_limit_size: faker.helpers.arrayElement([
      faker.number.int(),
      undefined,
    ]),
...
export const getGetUserByPublicidResponseMock = (
  overrideResponse: Partial<Extract<UserPublic, object>> = {},
): UserPublic => ({
  public_id: faker.helpers.arrayElement([
    faker.string.alpha({ length: { min: 10, max: 20 } }),
    undefined,
