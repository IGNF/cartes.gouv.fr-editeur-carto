 ...
 */
const flatGeomValue = ["text-value", "text-fill-color", "text-size", "stroke-color", "stroke-width"];
...
export { styleToFlatStyle, flatToIgnStyle, flatToIgnKey, flatToIGNKeyValue, ignStyleToFlatStyle, flatToIgn };
